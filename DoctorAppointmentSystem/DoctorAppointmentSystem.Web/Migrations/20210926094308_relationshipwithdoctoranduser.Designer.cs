...
namespace DoctorAppointmentSystem.Web.Migrations
{
    ...
    [Migration("20210926094308_relationshipwithdoctoranduser")]
    partial class relationshipwithdoctoranduser
    {
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Core.Entities.Doctor", b =>
                {
                    ...
                    b.HasOne("DoctorAppointmentSystem.Core.Entities.ExtendedIdentityUser", "AppUser")
                        .WithOne("Doctor")
                        .HasForeignKey("DoctorAppointmentSystem.Core.Entities.Doctor", "UserId");
                });
